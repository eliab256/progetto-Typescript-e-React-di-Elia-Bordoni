        ...
        <div className="startingPageContainer widthController">
            ...
            <div className="quizDescription">
                <p>
                    ...
                    Our planet faces challenges such as rising temperatures and the depletion of natural resources. It
                    is crucial for everyone to understand the impact of their daily actions and commit to reducing their
